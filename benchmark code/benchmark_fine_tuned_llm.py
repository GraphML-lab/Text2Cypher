...
client = OpenAI(
    base_url="http://localhost:8000/v1", api_key="abc", timeout=60.0, max_retries=2
)
is_seed = False
model_name: str = "granite-20b-code-instruct-8k-lora-tuned"
...
for item in test_dataset:  # item is a dict
    ...
    if is_seed:
        completion = client.chat.completions.create(
            model=f"/data/home/yilin/projects/lora-fine-tuned-llm/{model_name}",
            messages=[
                {
                    "role": "system",
